...
public final class SettingsDialog extends JDialog implements ConnectionStatusListener, JoystickButtonDetectionListener {
    ...
    private void refreshKeyboard() {
        ...
        if (room.awtControls().paddleMode) {
            keyP0UpL.setText("+ Speed ");
            keyP0DownL.setText("- Speed ");
            keyP1UpL.setText("+ Speed ");
            keyP1DownL.setText("- Speed ");
            keyboard0Icon.setIcon(paddleIcon);
            keyboard1Icon.setIcon(paddleIcon);
        } else {
            keyP0UpL.setText("Up");
            keyP0DownL.setText("Down");
            keyP1UpL.setText("Up");
            keyP1DownL.setText("Down");
            keyboard0Icon.setIcon(joystickIcon);
            keyboard1Icon.setIcon(joystickIcon);
        }
        String message;
        if (room.awtControls().p1ControlsMode) {
            keyboardPlayer1Lb.setText("Player 2");
            keyboardPlayer2Lb.setText("Player 1");
            message = "Swapped";
        } else {
            keyboardPlayer1Lb.setText("Player 1");
            keyboardPlayer2Lb.setText("Player 2");
            message = "";
        }
    ...
    private void refreshCartridge() {
        ...
        if (room.currentConsole().cartridgeSocket().inserted() == null) {
            ...
            ArrayList<CartridgeFormat> formats = new ArrayList<>();
            try {
    ...
    private void buildControlsFieldsLists() {
        keyboardFieldsList = Arrays.asList(keyP0Up, keyP0Down, keyP0Left, keyP0Right, keyP0Button, keyP0Button2,
                keyP1Up, keyP1Down, keyP1Left, keyP1Right, keyP1Button, keyP1Button2);
        joystick0FieldsList = Arrays.asList(joyP0Button, joyP0Button2, joyP0Select, joyP0Reset, joyP0Pause, joyP0FastSpeed);
        joystick1FieldsList = Arrays.asList(joyP1Button, joyP1Button2, joyP1Select, joyP1Reset, joyP1Pause, joyP1FastSpeed);
        joysticksFieldsList = new ArrayList<>(joystick0FieldsList);
        joysticksFieldsList.addAll(joystick1FieldsList);
        List<JTextField> all = new ArrayList<>(keyboardFieldsList);
    ...
    private void joyP0P1DeviceAction() {
        if (refreshInProgress) return;
    ...
    private void joyP0DeadzoneAction() {
    ...
    private void joyP0SensitivityAction() {
        if (!room.joystickControls().paddleMode) return;
    ...
    private void joyP1DeadzoneAction() {
    ...
    private void joyP1SensitivityAction() {
        if (!room.joystickControls().paddleMode) return;
    ...
    private void romFormatLbAction() {
        ...
        if (!(sel instanceof CartridgeFormat)) return;
    ...
    private void buildGUI() {
        ...
        JPanel joysticksPanel;
        {
            ...
            serverStartB.addActionListener(e -> serverStartAction());
            ...
            clientConnectB.addActionListener(e -> clientConnectAction());
            clientConnectB.setBounds(341, 36, 108, 26);
            multiplayerPanel.add(clientConnectB);

            clientServerAddressTf = new JTextFieldNim();
            clientServerAddressTf.addActionListener(e -> clientConnectAction());
            ...
            serverPortTf.addActionListener(e -> serverStartAction());
            ...
            joyP0Deadzone.addActionListener(e -> joyP0DeadzoneAction());
            joyP0Deadzone.setModel(new DefaultComboBoxModel(JOY_DEADZONE_OPTIONS));
            ...
            joyP1Deadzone.addActionListener(e -> joyP1DeadzoneAction());
            joyP1Deadzone.setModel(new DefaultComboBoxModel(JOY_DEADZONE_OPTIONS));
            ...
            joyP0Sensitivity.addActionListener(e -> joyP0SensitivityAction());
            ...
            joyP1Sensitivity.addActionListener(e -> joyP1SensitivityAction());
            ...
            romFormatLb.addListSelectionListener(e -> romFormatLbAction());
            ...
            helpPanel.add(lblHotKeys);
            {
                ...
                lblVersion.setBounds(52, 202, 120, 14);
                ...
                }
                {
                    ...
                    lblHttpjavatariorg.addActionListener(e -> officialWebPageAction());
                ...
                }
                {
                    ...
                    lblppeccin.addActionListener(e -> twitterPageAction());
        ...
        }
        {
            ...
            buttonPane.setLayout(new BorderLayout(0, 0));
            {
                ...
                defaultsB.addActionListener(e -> defaultsAction());
                panel.add(defaultsB);
                ...
                buttonPane.add(panel_1, BorderLayout.EAST);
                {
                    ...
                    panel_1.add(closeB);
                    closeB.addActionListener(e -> closeAction());
        ...
        joyP0XAxis.addActionListener(e -> joyP0XAxisAction());
        ...
        joyP0YAxis.addActionListener(e -> joyP0YAxisAction());
        ...
        joyP1XAxis.addActionListener(e -> joyP1XAxisAction());
        ...
        joyP1YAxis.addActionListener(e -> joyP1YAxisAction());
        ...
        joyP0Device.addActionListener(e -> joyP0P1DeviceAction());
        ...
        joyP1Device.addActionListener(e -> joyP0P1DeviceAction());
