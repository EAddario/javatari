...
public final class SwingHelper {
    ...
    private static BufferedImage asCompatibleImage(Image img) {
    ...
    private static BufferedImage asCompatibleImage(Image img, int transparency) {
    ...
    private static GraphicsConfiguration defaultScreenDeviceConfiguration() {
